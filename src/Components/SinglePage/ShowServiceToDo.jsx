...
const ShowServiceToDo = ({ item }) => {
    ...
    const handleStatusChange = (e, id) => {
      const updatedStatus = e.target.value; // Capture the new status
      setNewServiceStatus(updatedStatus); // Update the state
      console.log(updatedStatus); // Log the updated value for debugging
